...
describe(`${partitionByMin.name}()`, () => {
  test("should not change the array when min equals max", () => {
    const keys = [0, 1, 2, 3];
  ...
  test("should not change the array when min is greater than max", () => {
    const keys = [0, 1, 2, 3];
    const values = [10, 20, 30, 40];
  ...
  test("should handle the case where all elements are the same", () => {
    const keys = [0, 1, 2, 3];
  ...
  test("should return initial index + 1 when values are ascending", () => {
    const keys = [0, 1, 2, 3];
    const values = [10, 20, 30, 40];
  ...
  test("should return initial index + 1 when all values are greater", () => {
  ...
  test("should return initial index + 1 when values are descending", () => {
    const keys = [3, 2, 1, 0];
    const values = [10, 20, 30, 40];
    const mid = partitionByMin(keys, values, 1);
    expect(mid).toBe(2);
  ...
  test("should partition correctly with integers", () => {
    const keys = [0, 1, 2, 3, 4];
  ...
  test("should partition correctly with multiple min integers", () => {
  ...
  test("should partition correctly for example 1", () => {
  ...
  test("should partition correctly for example 2", () => {
